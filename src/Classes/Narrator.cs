...
namespace DuelingDuelsters.Classes
{
    ...
    public class Narrator
    {
       ...
       /// <returns>A description of the round's outcome.</returns>
        ...
        /// <summary>
        /// Menu for selecting the number of players in a match. If the player selects single player, the passed <paramref name="brain"/> is converted to a <c>Computer</c> brain. If the player selects two player, the passed <paramref name="brain"/> is converted a <c>Human</c> brain.
        /// </summary>
        ...
        /// <summary>
        /// Selects an action for a computer player during a round based on numbers generated by a <see cref="Random"></see> instance.
        /// </summary>
